...
(12, 'Wurmli', '1.0', '2021-02-14 14:46:18', 8, 'Wurmli_20210214154618.gif', 'A snake game for the CMM2', '', 'https://github.com/NautilusDE/Wurmli', '3', 8, 1),
(13, 'MasterMind', '0.01', '2021-02-14 19:23:24', 2, 'MasterMind_20210214201326.jpg', 'Simple logic game from childhood', 'On the game begin computer randomly selects N colours from MAX count and store this as secret row. Task for player is to guess correct row with placing own choices in every round. On the round end, computer tells with GREENs points how many colors are on right places and with REDs how many are correct colour in wrong place. This should help the player in next row. You can adjust the game difficulty to match yours skill...', 'https://github.com/jirsoft/MasterMind', '3', 4, 1),
(14, 'CMM2 Welcome Tape', 'Release 1.0.0', '2021-02-14 21:29:36', 11, 'welcome_20210215175647.png', 'First program to run on CMM2', 'An introductory collection of programs for the Colour Maximite 2 in the vein of the Sinclair Spectrum "Horizons" tape, BBC Micro "Welcome" tape/disk and Apple II.\n\nCreated as a collaborative effort by the denziens of "The Back Shed" and curated by Tom Williams "thwill".', 'https://github.com/thwill1000/cmm2-welcome', '1,2', 4, 1),
(15, 'FalFus2', 'r3', '2021-02-14 21:49:40', 5, 'Falfus2_20210214223426.png', 'Logic puzzle game', 'Decades ago, I wrote a logic puzzle game for my Apple //gs with a Second Sight VGA card. Falfus was based on the game Puzznic. The goal was to clear each level by sliding matching tiles together. Two or more of the same tile touching along any edge would fuse and vanish with a pop. The player can slide tiles sideways only, and tiles fall when unsupported.', 'https://www.thebackshed.com/forum/uploads/vegipete/2020-09-03_120743_%3Cfont%20color=red%3E%3Cb%3EFALFUS2%3C/b%3E%3C/font%3E_r3.zip', '3', 3, 1),
(16, 'Flappy Bird', '', '2021-02-14 21:52:20', 9, 'FlappyBird_20210217193920.png', '', '', 'https://www.thebackshed.com/forum/uploads/jeff510/2020-07-19_172139_FLAPPY_BIRD.zip', '3', 5, 1),
(17, 'Guardian', '', '2021-02-14 21:53:28', 10, 'Defender_20210214224158.jpg', 'Defender clone', '', 'https://github.com/thwill1000/cmm2-welcome/tree/master/games/guardian', '3', 4, 1),
(18, 'Tank versus UFO', '1.0', '2021-02-15 15:47:46', 12, 'Tank_vs_UFO_20210215164746.png', 'Simple ASCII graphics game', 'Shoot UFOs with your tank but beware of their bombs!', 'https://www.thebackshed.com/forum/uploads/Schlowski/2021-02-17_070307_TanksVersusUFOs.zip', '3', 1, 1),
(19, 'Crate Away', '1.6b', '2021-02-15 23:44:12', 5, 'CrateAway_20210215125851.png', 'Addictive logical game', 'More levels can be found  <a target="_blank" href=https://www.sourcecode.se/sokoban/levels>HERE</a>', 'https://www.thebackshed.com/forum/uploads/fuse/2020-12-12_014257_CrateAway15b.zip', '3', 4, 1),
(20, 'CMM2 User Manual', 'v5.06.00', '2021-02-16 10:25:40', 13, 'CMM2userManual_20210216112442.JPG', 'Most important guide for any CMM2 owner', 'This is USER GUIDE for last official firmware for CMM2.', 'https://geoffg.net/Downloads/Maximite/Colour_Maximite_2_User_Manual.pdf', '12', 10, 1),
...
CREATE TABLE IF NOT EXISTS `shadow` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci AUTO_INCREMENT=112 ;
